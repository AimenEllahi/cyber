...
//       onUpdate: (self) => {
//         if (mixer.current) {
//           mixer.current.setTime(self.progress * 10);
//         }
//       },
//     });
//   }, []);
...
function App() {
  ...
  return (
    <div>
      ...
      <div
        id='nav'
        className='flex items-center justify-between h-7 w-full fixed z-50 px-4'
      >
        <h3 className='font-gilroy font-normal text-22'>CYBERFICTION*</h3>
        <button className='px-10 py-2 rounded-full bg-black text-white border-none'>
          APRIL, 2023
        </button>
      </div>
      <div id='main' className='relative overflow-hidden'>
        <div id='page' className='relative h-screen w-screen bg-gray-200'>
          <div
            id='loop'
            className='flex absolute top-30 h-25 w-full font-gilroy text-100'
          >
            <h1 className='font-normal animate-loop'>
              CYBERFICTION IS THE{" "}
              <b>
                <i>REAL</i>
              </b>{" "}
          ...
          <h4 className='absolute top-62 font-gilroy font-semibold left-25'>
            ...SCROLL TO READ
          </h4>
        </div>
        <div id='page1' className='relative h-screen w-screen bg-gray-200'>
          <div id='right-text' className='absolute top-30 left-10'>
            <h3 className='font-gilroy font-normal text-gray-700'>
              CYBERFICTION / KEY WORD
            </h3>
            <h1 className='font-normal text-50 leading-1.5'>
              HAVE FUN
              <br />
              LET'S PLAY
              <br />
        ...
        <div id='page2' className='relative h-screen w-screen bg-gray-200'>
          <div id='text1' className='absolute top-30 left-10'>
            ...
            <h1 className='font-normal text-60 leading-1.5'>
              LET'S
              <br />
              HAVE FUN
              <br />
          ...
          <div id='text2' className='absolute top-55 right-10 text-right'>
            <p className='text-gray-700 font-gilroy font-normal'>
              ...
              CAN STAND <br /> THERE IN THE NOT-TOO-DISTANT FUTURE AND DREAM OF
              ANOTHER NEW <br /> FUTURE
            </p>
          </div>
        </div>
        <div id='page3' className='relative h-screen w-screen bg-gray-200'>
          <div id='text3' className='absolute top-40 right-10 text-right'>
            ...
            <h1 className='font-normal text-70 leading-1.5'>
              CYBERFIELD
              <br />
              IS OUR
              <br />
